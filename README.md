...
Seleção: Escolha da base de dados sem valores ausentes.

Pré-processamento: Remoção de identificadores (id) e tradução dos dados para melhor interpretabilidade.

Mineração (Data Mining): Utilização do algoritmo J48 (implementação do C4.5) para gerar uma Árvore de Decisão.

Avaliação: Validação do modelo via 10-Fold Cross-Validation.
...
[Seu Nome Aqui]
Projeto desenvolvido para a disciplina de [Nome da Disciplina] - 2025.
